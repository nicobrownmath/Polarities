...
{
    public class ConvectiveWandererBag : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("{$Mods.Polarities.ItemName.TreasureBag} ({$Mods.Polarities.NPCName.ConvectiveWanderer})");
        ...
        {
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ItemType<BuildingEruption>(), 1));
