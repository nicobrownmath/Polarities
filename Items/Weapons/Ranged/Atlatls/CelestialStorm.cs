...
namespace Polarities.Items.Weapons.Ranged.Atlatls
{
    ...
    public class CelestialStormProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.rotation -= (float)Projectile.direction * (MathHelper.Pi * 2f) / 120f;
            ...
            if (Main.rand.NextBool(2))
            {
                ...
                dust59.position = Projectile.Center - vector152 * (float)Main.rand.Next(10, 21);
            ...
            Projectile.ai[1] -= (float)Projectile.direction * (MathHelper.Pi / 8f) / 50f;
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Vector2 origin14 = new Vector2((float)texture2D20.Width, (float)texture2D20.Height) / 2f;

            Color color72 = alpha7 * 0.8f;
            color72.A = (byte)((int)color72.A / 2);
            ...
            Main.EntitySpriteDraw(TextureAssets.Extra[50].Value, vector64, (Rectangle?)null, color73, 0f - Projectile.rotation + 0.35f, origin14, scale6, (SpriteEffects)((int)spriteEffects ^ 1), 0);
            Main.EntitySpriteDraw(TextureAssets.Extra[50].Value, vector64, (Rectangle?)null, alpha7, 0f - Projectile.rotation, origin14, Projectile.scale, (SpriteEffects)((int)spriteEffects ^ 1), 0);
            Main.EntitySpriteDraw(texture2D20, vector64, (Rectangle?)null, color72, (0f - Projectile.rotation) * 0.7f, origin14, Projectile.scale, (SpriteEffects)((int)spriteEffects ^ 1), 0);
            Main.EntitySpriteDraw(TextureAssets.Extra[50].Value, vector64, (Rectangle?)null, alpha7 * 0.8f, Projectile.rotation * 0.5f, origin14, Projectile.scale * 0.9f, spriteEffects, 0);
            alpha7.A = 0;

            Main.EntitySpriteDraw(texture2D20, vector64, (Rectangle?)null, alpha7, Projectile.rotation, origin14, Projectile.scale, spriteEffects, 0);
